// Cloudflare Pages Function for handling contact form submissions with Resend
...
export async function onRequestPost(context) {
  try {
    ...
    const { name, company, email, phone, product, destination, message } = data;
    ...
    const [companyResult, customerResult] = results;
    
    if (!companyResult.ok || !customerResult.ok) {
